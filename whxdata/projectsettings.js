...
rh = window.rh;
model = rh.model;
var defaultTopic = "Escritos/0_Aspectos_Generales/01.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("Escritos/0_Aspectos_Generales/01.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', 'b38fff17-507f-4923-b842-c5a6e8648897' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Cuentas Individuales");
